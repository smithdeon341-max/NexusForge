    ...
    <main className="min-h-screen bg-black flex items-center justify-center p-4 font-mono text-sky-400 text-center">
      <div className="w-full max-w-md bg-zinc-950 rounded-3xl shadow-[0_30px_80px_rgba(0,0,0,0.75)] border border-zinc-800 overflow-hidden">
        ...
        <div className="border border-zinc-700 rounded-b-none rounded-t-3xl p-8 text-center relative overflow-hidden bg-zinc-950/95">
          ...
          <Cpu className="text-sky-400 mx-auto mb-4 glow-text" size={48} />
          <h1 className="text-3xl md:text-4xl uppercase font-black text-sky-400 glow-text tracking-[0.45em] leading-tight">
            NexusForge LLC
          </h1>
          <p className="text-sky-400 text-sm md:text-base mt-3 uppercase tracking-[0.35em] glow-text">
        ...
        <div className="p-8 space-y-6 bg-white border-t border-zinc-800 text-center">
          <div className="flex flex-col items-center gap-3 mb-6 bg-zinc-900 p-4 rounded-3xl border border-zinc-800 glow-border">
            <ShieldCheck className="text-sky-400 shrink-0 glow-text" size={24} />
          ...
          <form onSubmit={handleVerifyCode} className="space-y-6 mx-auto max-w-md text-center">
            <div className="space-y-2">
              <label htmlFor="code" className="text-sm font-bold text-sky-400 uppercase tracking-[0.35em] block glow-text">
                Access Code
              </label>
            ...
            <button
              ...
              className="w-full rounded-3xl border border-zinc-800 bg-sky-500 px-6 py-4 text-black font-bold transition hover:bg-sky-400 disabled:opacity-70 flex items-center justify-center gap-2 mx-auto glow-border"
            >
              {isLoading ? (
          ...
          <div className="mt-8 border-t border-zinc-800 pt-6">
            <p className="text-sm text-sky-400 uppercase tracking-[0.35em] glow-text">
              Are you an administrator? <a href="/admin/login" className="text-sky-400 font-bold hover:underline glow-text">Sign in here</a>
            </p>
          </div>
        </div>
        <div className="h-3 bg-white" />
        ...
        <div className="border-t border-zinc-700 p-6 text-center bg-zinc-950/95 glow-border">
          ...
          <p className="text-sky-400 uppercase tracking-[0.35em] text-sm font-semibold mt-2 glow-text">
            Deon Smith
          </p>
        </div>
      </div>
